...
/* harmony import */ var _vendor_scroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/scroll.js */ "./js/vendor/scroll.js");
// Swiper 8.4.7
...
!function (e, t) {
      ...
      we = se.onRelease = function (t) {
        if (!cf(t, 1)) {
          ...
          !n && e && (se._vx.reset(), se._vy.reset(), s && Q && _e.delayedCall(.08, function () {
            if (300 < Le() - ye && !t.defaultPrevented) if (t.target.click) t.target.click();else if (ve.createEvent) {
  ...
  function mc(e, t, r, n, o, i, a, s, l, c, u, f, d, p) {
    ...
    var g,
      ...
      v,
      b = d ? d.time() : 0;
    if (d && d.seek(0), isNaN(e) || (e = +e), Ua(e)) d && (e = Fe.utils.mapRange(d.scrollTrigger.start, d.scrollTrigger.end, 0, f, e)), a && X(a, r, n, !0);else {
      Ta(t) && (t = t(s));
      var m,
        y,
        x,
  ...
  var Fe,
    ...
    ne = (ScrollTrigger.prototype.init = function init(E, O) {
      if (this.progress = this.start = 0, this.vars && this.kill(!0, !0), st) {
        ...
        if (Ce._startClamp = Ce._endClamp = !1, Ce._dir = he, M *= 45, Ce.scroller = be, Ce.scroll = de ? de.time.bind(de) : Be, A = Be(), Ce.vars = E, O = O || E.animation, "refreshPriority" in E && (Qe = 1, -9999 === E.refreshPriority && (nt = Ce)), c.tweenScroll = c.tweenScroll || {
          ...
          var e = Be(),
            t = it() - Ee < 500,
            r = B.tween;
          if (!(t || Math.abs(Ce.getVelocity()) < 10) || r || Ge || Me === e) Ce.isActive && Me !== e && te.restart(!0);else {
            var n = (e - R) / N,
        ...
        if (Ce.previous = function () {
          ...
          if (!Ke && Ce.enabled || t) if (ae && e && at) wb(ScrollTrigger, "scrollEnd", Ob);else {
            ...
            if (R += w, I += w, Ce._startClamp && (Ce._startClamp += w), Ce._endClamp && !tt && (Ce._endClamp = I || -.001, I = Math.min(I, Qa(be, he))), N = I - R || (R -= .01) && .001, x && (Oe = Fe.utils.clamp(0, 1, Fe.utils.normalize(R, I, re))), Ce._pinPush = _, q && w && ((o = {})[he.a] = "+=" + w, k && (o[he.p] = "-=" + Be()), Fe.set([q, L], o)), !ae || $e && Ce.end >= Qa(be, he)) {
              if (ie && Be() && !de) for (i = ie.parentNode; i && i !== We;) i._pinOffset && (R -= i._pinOffset, I -= i._pinOffset), i = i.parentNode;
          ...
          if (!de || r || e) {
            ...
            if (t && (D = A, A = de ? Be() : u, ue && (_ = w, w = O && !ve ? O.totalProgress() : d)), M && !d && ae && !Ke && !ot && at && R < u + (u - D) / (it() - Ue) * M && (d = 1e-4), d !== p && Ce.enabled) {
              ...
              })), ve || (!ee || Ke || ot ? O && O.totalProgress(d, !(!Ke || !Ee && !e)) : (ee._dp._time - ee._start !== ee._time && ee.render(ee._dp._time - ee._start), ee.resetTo ? ee.resetTo("totalProgress", d, O._tTime / O._tDur) : (ee.vars.totalProgress = d, ee.invalidate().restart()))), ae) if (e && se && (U.style[se + he.os2] = m), ye) {
                if (a) {
                  if (l = !e && p < d && u < I + 1 && u + 1 >= Qa(be, he), fe) if (e || !n && !l) oc(ae, U);else {
                    var g = xt(ae, !0),
                      h = u - R;
          ...
          if (Ce.enabled && (!1 !== e && Ce.revert(!0, !0), Ce.enabled = Ce.isActive = !1, t || ee && ee.pause(), re = 0, n && (n.uncache = 1), Se && xb(ScrollTrigger, "refreshInit", Se), te && (te.pause(), B.tween && B.tween.kill() && (B.tween = 0)), !me)) {
            for (var r = Tt.length; r--;) if (Tt[r].scroller === be && Tt[r] !== Ce) return;
      ...
      if (He = window, Ne = document, Xe = Ne.documentElement, We = Ne.body, Fe && (Je = Fe.utils.toArray, Ve = Fe.utils.clamp, x = Fe.core.context || Ha, Ze = Fe.core.suppressOverwrites || Ha, w = He.history.scrollRestoration || "auto", Q = He.pageYOffset, Fe.core.globals("ScrollTrigger", ScrollTrigger), We)) {
        st = 1, (_ = document.createElement("div")).style.height = "100vh", _.style.position = "absolute", Yb(), function _rafBugFix() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _gsap_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gsap.min */ "./js/vendor/gsap.min.js");
/* harmony import */ var _gsap_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gsap_min__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _scroll_trigger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scroll-trigger */ "./js/vendor/scroll-trigger.js");
/* harmony import */ var _scroll_trigger__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_scroll_trigger__WEBPACK_IMPORTED_MODULE_1__);


_gsap_min__WEBPACK_IMPORTED_MODULE_0__["gsap"].registerPlugin(_scroll_trigger__WEBPACK_IMPORTED_MODULE_1__["ScrollTrigger"]);
var blocks = document.querySelectorAll('[data-scroll]');
blocks.forEach(function (content) {
  _gsap_min__WEBPACK_IMPORTED_MODULE_0__["gsap"].from(content, {
    scrollTrigger: {
      trigger: content,
      start: 'top bottom',
