...
/* harmony import */ var _modules_select_custom_select__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/select/custom-select */ "./js/modules/select/custom-select.js");
...
/* harmony import */ var _modules_header_init_header_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/header/init-header.js */ "./js/modules/header/init-header.js");
/* harmony import */ var _modules_accordion_init_accordion_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/accordion/init-accordion.js */ "./js/modules/accordion/init-accordion.js");
/* harmony import */ var _modules_video_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/video.js */ "./js/modules/video.js");
/* harmony import */ var _modules_partners_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/partners.js */ "./js/modules/partners.js");
/* harmony import */ var _modules_header_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/header.js */ "./js/modules/header.js");
...
/* harmony import */ var _modules_aside_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/aside.js */ "./js/modules/aside.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_header_init_header_js__WEBPACK_IMPORTED_MODULE_4__["initHeader"])();
  Object(_modules_header_js__WEBPACK_IMPORTED_MODULE_8__["blurHeader"])();

  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', function () {
    Object(_modules_input_file_init_upload__WEBPACK_IMPORTED_MODULE_3__["uploadFile"])();
    Object(_modules_input_file_init_upload__WEBPACK_IMPORTED_MODULE_3__["uploadImageDrop"])();
    var select = new _modules_select_custom_select__WEBPACK_IMPORTED_MODULE_2__["CustomSelect"]();
    select.init();
    ...
    Object(_modules_accordion_init_accordion_js__WEBPACK_IMPORTED_MODULE_5__["initAccordions"])();
    Object(_modules_video_js__WEBPACK_IMPORTED_MODULE_6__["playVideo"])();
    Object(_modules_partners_js__WEBPACK_IMPORTED_MODULE_7__["arrangePartners"])();
    Object(_modules_partners_js__WEBPACK_IMPORTED_MODULE_7__["animatePartners"])();
    Object(_modules_aside_js__WEBPACK_IMPORTED_MODULE_10__["openAside"])();
  });
});
...
/*!*****************************!*\
  !*** ./js/modules/aside.js ***!
  \*****************************/
/*! exports provided: openAside */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openAside", function() { return openAside; });
...
function successNotification() {
  ...
  var inputWrapper = document.getElementById('input-email');
...
/*!******************************!*\
  !*** ./js/modules/header.js ***!
  \******************************/
/*! exports provided: blurHeader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "blurHeader", function() { return blurHeader; });
...
function blurHeader() {
  window.addEventListener('scroll', function () {
    var scrollPositionLive = window.scrollY;
...
/* harmony import */ var _sticky_header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sticky-header */ "./js/modules/header/sticky-header.js");


var initHeader = function initHeader() {
  var burger = new _burger__WEBPACK_IMPORTED_MODULE_0__["Burger"]();
  burger.init();
  var stickyHeader = new _sticky_header__WEBPACK_IMPORTED_MODULE_1__["StickyHeader"]();
  stickyHeader.init();
};
...
/* harmony import */ var _vendor_gsap_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/gsap.min */ "./js/vendor/gsap.min.js");
...
var parallax = function parallax() {
  var parallaxItems = document.querySelectorAll('[data-parallax-mouse]');
  ...
  var handleMouseMove = function handleMouseMove(e) {
    var target = e.currentTarget || e.target; // Используем e.currentTarget, если доступен, в противном случае используем e.target
  ...
  var updateParallax = function updateParallax(target) {
    // eslint-disable-next-line no-undef
    if (!target) {
      return;
    } // Добавим проверку на существование target

    var section = target.classList && (target.classList.contains('section') ? target : target.closest('.section'));
    if (section) {
      parallaxItems.forEach(function (item) {
        if (section.contains(item)) {
          var movement = item.dataset.movement ? item.dataset.movement : 1;
          // eslint-disable-next-line no-undef
          _vendor_gsap_min__WEBPACK_IMPORTED_MODULE_0__["gsap"].to(item, {
  ...
  // eslint-disable-next-line no-undef
  _vendor_gsap_min__WEBPACK_IMPORTED_MODULE_0__["gsap"].ticker.add(updateParallax); // вместо нового requestAnimationFrame используем rAF гсапа
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "arrangePartners", function() { return arrangePartners; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animatePartners", function() { return animatePartners; });
var elements = document.querySelectorAll('.partners__element-wrapper');
var icons = document.querySelectorAll('.partners__icon-wrapper');
var svgs = document.querySelectorAll('.partners__icon-wrapper img');
...
function animatePartners() {
  function animateCollection() {
    svgs.forEach(function (element) {
      var randomSize = Math.floor(Math.random() * 50) + 50;
      element.style.width = "".concat(randomSize + 10, "%");
      element.style.height = "".concat(randomSize + 10, "%");
    });
...
function arrangePartners() {
  if (howMany > 1) {
    ...
    icons[lastIndex].style = "transform: rotate(".concat(maxDegree * -1, "deg);");
    icons[0].style = "transform: rotate(".concat(minDegree * -1, "deg);");
    elements[lastIndex].style = "transform: rotate(".concat(maxDegree, "deg);");
    if (other) {
      var degree = fullDegree / (other + 1);
      var newDegree = 5;
...
!function (t, e) {
  ...
  function yl(t) {
    var e,
      ...
      a = k() - z,
      s = !0 === t;
    if (M < a && (A += a - C), (0 < (e = (i = (z += a) - A) - D) || s) && (n = ++g.frame, b = i - 1e3 * g.time, g.time = i /= 1e3, D += e + (E <= e ? 4 : E - e), r = 1), s || (p = _(yl)), r) for (O = 0; O < B.length; O++) B[O](i, b, n, t);
  }
  function gn(t) {
  ...
  $t.version = Xt.version = ze.version = "3.12.3", o = 1, x() && Ft();
  function vd(t, e) {
